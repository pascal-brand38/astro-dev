...
import LayerControl from './astro-leaflet/LayerControl.astro'
...
<Card title="Layer Control" icon="pencil">
  ...
  users to easily switch different layers on your map
	...
	<LinkButton href="https://github.com/pascal-brand38/astro-dev/blob/main/src/content/docs/packages/astro-leaflet/LayerControl.astro" icon="external">
		Full code
	</LinkButton>
