...
import SplideHeader from './astro-splide/SplideHeader.astro'
...
<Card title="Simple Example" icon="pencil">
	...
	<LinkButton href="https://github.com/pascal-brand38/astro-dev/blob/main/sites/astro-dev-doc/src/content/docs/packages/astro-splide/SimpleExample.astro" icon="external">
		Full code
	</LinkButton>
