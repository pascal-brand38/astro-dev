...
import AutoplayExample from '../../../components/astro-splide/AutoplayExample.astro'
import ExtensionExample from '../../../components/astro-splide/ExtensionExample.astro'
...
<Card title="Basic Example" icon="pencil">
	...
	Check [full code](https://github.com/pascal-brand38/astro-dev/blob/main/sites/astro-dev-doc/src/components/astro-splide/BasicExample.astro)
...
<Card title="Autoplay Example" icon="pencil">
	...
	Check [full code](https://github.com/pascal-brand38/astro-dev/blob/main/sites/astro-dev-doc/src/components/astro-splide/AutoplayExample.astro)
...
<Card title="Extension Example" icon="pencil">
	...
	* Limitation: a single extension can be used per page
	...
	Check [full code](https://github.com/pascal-brand38/astro-dev/blob/main/sites/astro-dev-doc/src/components/astro-splide/ExtensionExample.astro)
