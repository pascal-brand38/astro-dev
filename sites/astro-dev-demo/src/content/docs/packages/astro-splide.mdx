...
<Card title="Autoplay Example" icon="pencil">
	...
	See this example at
	[this page](https://github.com/pascal-brand38/astro-dev/tree/main/packages/astro-splide/examples/components/AutoplayExample.astro)
...
<Card title="Extension Example" icon="pencil">
	...
	* Limitation: a single extension can be used per page
	...
	See this example at
	[this page](https://github.com/pascal-brand38/astro-dev/tree/main/packages/astro-splide/examples/components/ExtensionExample.astro)
